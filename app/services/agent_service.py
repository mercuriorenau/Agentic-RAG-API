...
SYSTEM_PROMPT = (
    ...
    "Only when the retrieval budget note explicitly tells you to open with a coverage "
    "caveat (demo capped top_k on a survey), start with one short sentence about partial "
    "coverage. For normal focused questions, answer directly. Do not invent a "
    "'partial coverage' / 'cobertura parcial' disclaimer. "
