...
class PendingSignup(Base):
    ...
    email_verify_token_hash: Mapped[str] = mapped_column(String(255), nullable=False)
    email_verify_code_hash: Mapped[str] = mapped_column(String(255), nullable=False)
    email_verify_expires_at: Mapped[datetime] = mapped_column(
